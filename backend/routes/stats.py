...
def get_artist_stats(artist_id):
    ...
    # ⚡ Bolt Optimization: Cache expensive analytics dashboard (15+ queries)
    # Expected Impact: Reduces endpoint latency from ~500ms to <5ms on cache hit.
    # We cache the raw dictionary payload instead of the Flask Response object to avoid thread-safety issues.
