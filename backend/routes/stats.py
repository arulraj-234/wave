...
def get_artist_stats(artist_id):
    ...
    # ⚡ Bolt Optimization: Cache the complex analytics response (16+ SQL queries)
    # This prevents the database from being hammered by frequent dashboard reloads.
    # We cache the raw dict payload (not the Response object) for thread safety.
