    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="relative h-full flex-grow overflow-hidden rounded-full bg-white/10 pointer-events-none">
              <div className="absolute h-full bg-brand-primary rounded-full transition-all pointer-events-none" style={{ width: `${getRangePercentage()}%` }} />
            </div>
          </motion.div>
        </div>
      ...
      <p className="absolute text-brand-muted transform -translate-y-4 text-xs font-medium tracking-wide hidden">
        {Math.round(value)}
      </p>
    </>
  );
